...
export type LotteryOpen = ContractEventLog<{
  ...
  startTime: string;
  endTime: string;
  priceTicketInHegem: string;
  firstTicketId: string;
  hegemInjectedAmount: string;
...
export interface LotteryABIAbi extends BaseContract {
  constructor(
    jsonInterface: any[],
    address?: string,
  ...
  methods: {
    ...
    hegemPendingInjectionNextLottery(): NonPayableTransactionObject<string>;

    hegemToken(): NonPayableTransactionObject<string>;
    ...
    maxPriceTicketInHegem(): NonPayableTransactionObject<string>;

    minPriceTicketInHegem(): NonPayableTransactionObject<string>;
    ...
    setMinAndMaxTicketPriceInHegem(
      _minPriceTicketInHegem: number | string | BN,
      _maxPriceTicketInHegem: number | string | BN
    ): NonPayableTransactionObject<void>;
    ...
    startLottery(
      ...
      _priceTicketInHegem: number | string | BN,
      _heraAmount: number | string | BN,
      _hegemRewardsBreakdown: (number | string | BN)[],
