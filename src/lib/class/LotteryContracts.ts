...
class LotteryContracts {
  ...
  constructor(web3: Web3 = new Web3(RPC_BSC)) {
    this.hegem = new web3.eth.Contract(
      lotteryHegemABI as AbiItem[],
      LOTTERY_HEGEM_CONTRACT
    );

    this.HERA = new web3.eth.Contract(
      lotteryHeraABI as AbiItem[],
